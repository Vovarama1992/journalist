...
— Полностью удалить это совпадающее начало.
...
— СПИКЕР:
— Затем переписанный, чистый, гладкий текст.

Жёсткое обязательное правило:
— Если в итоговом тексте появляется СПИКЕР:, он ВСЕГДА должен быть с новой строки. Никогда не вставлять СПИКЕР внутри строки.

Стиль:
— Плавная человеческая речь.
— Никаких повторов.
...
— Один читабельный фрагмент, готовый к склейке.`
